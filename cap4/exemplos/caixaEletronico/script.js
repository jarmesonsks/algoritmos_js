const frm = document.querySelector("form") // obtém dados da pagina
const resp1 = document.querySelector("#outResp1")
const resp2 = document.querySelector("#outResp2")
const resp3 = document.querySelector("#outResp3")

frm.addEventListener("submit", (e) => { // escuta o evento
    e.preventDefault()
    const saque = Number(frm.inSaque.value) //obtém o valor do form
    if (saque % 10 != 0) {
